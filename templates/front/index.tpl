...
<head>
    ...
    <link href='//fonts.googleapis.com/css?family=Roboto+Condensed:400,700&subset=latin,cyrillic-ext' rel='stylesheet'
          type='text/css'>
    <link href="{$core.page.nonProtocolUrl}modules/countdown/templates/front/css/style.css" rel="stylesheet"
          type="text/css">
</head>
<body>
<div class="wrapper">
